...
public class ShellCommandTest {
    ...
    public void rmdirTest(){
        ...
        shell.execute("cd /home/");
        shell.execute("mkdir Cs680");
        System.out.println("To check new directory created: ");
        shell.execute("dir ");
        shell.execute("rmdir Cs680");
    ...
    public void chownTest(){
        ...
        shell.execute("chown Chaitu /root/home/pictures/");
        shell.execute("cd /root/home/");
        System.out.println("To check new directory owner changed Chaitu : ");
        shell.execute("dir ");
        System.out.println("");
    }
